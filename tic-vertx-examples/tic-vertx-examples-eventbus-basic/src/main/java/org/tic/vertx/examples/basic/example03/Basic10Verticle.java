...
public class Basic10Verticle extends AbstractVerticle {

    private static final Logger logger = LoggerFactory.getLogger(Basic10Verticle.class);

    @Override
    public void start() throws Exception {

        logger.debug(Basic10Verticle.class.getName() + " has been deployed succeed!");
