...
public class Basic02Verticle extends AbstractVerticle {
    private static final Logger logger = LoggerFactory.getLogger(Basic02Verticle.class);

    @Override
    public void start() throws Exception {

        logger.debug(Basic02Verticle.class.getName() + " has been deployed succeed!");
