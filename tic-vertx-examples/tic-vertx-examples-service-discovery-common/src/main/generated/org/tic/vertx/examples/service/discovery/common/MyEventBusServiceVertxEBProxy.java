...
public class MyEventBusServiceVertxEBProxy implements MyEventBusService {
  ...
  public MyEventBusServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public MyEventBusServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
