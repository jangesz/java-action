...
public class AccountRepositoryVertxEBProxy implements AccountRepository {
  ...
  public AccountRepositoryVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public AccountRepositoryVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
